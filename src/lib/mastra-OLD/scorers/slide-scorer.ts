// src/lib/mastra/scorers/slide-scorer.ts

import { createScorer } from '@mastra/core/scores';

export const slideVisualScorer = createScorer({
  name: 'Slide Visual Quality',
  description: 'Evaluates if the Excalidraw slide layout is well-organized and matches the representation.',
  type: 'agent',
  judge: {
  model: {
